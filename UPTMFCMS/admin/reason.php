...
<div class="body-wrapper" ng-controller="myCtrl" ng-init="init()" id="root">
  <div class="container-fluid p-4">
    <div class="row">
      <div class="col-lg-12 mb-3">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalCreate"> <i class="fas fa-plus me-2"></i> Reason</button>
      </div>
      <div class="col-lg-12 d-flex align-items-stretch">
        <div class="card w-100">
          <div class="card-body p-4">
            <h5 class="card-title fw-semibold mb-4">Reason</h5>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Create Reason</h1>
  ...
  <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEdit" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Update Reason</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
...
<script type="text/javascript">
  app.controller("myCtrl", function myCtrl($scope, $http, $timeout) {
    ...
    $scope.openEdit = (info) => {
      $scope.categoryData = info;
      $('#edit').val(info.category_title);
    ...
    $scope.update = () => {
      ...
      $http.get('../api/api_category.php', {
        params: {
          task: "UpdateCategory",
          category_id: $scope.categoryData.category_id,
          category_title: cat,
        }
      }).then(response => {
        var data = response.data;
    ...
    $scope.delete = (info) => {
      ...
      swalWithBootstrapButtons.fire({
        text: `Are you sure to delete "${info.category_title}"? You won't be able to revert!`,
        icon: "warning",
