...
<style>
  @font-face {
    font-family: "poppins";
    src: url("./lib/fonts/Poppins-Regular.ttf") format("opentype");
    font-weight: normal;
    font-style: normal;
  }
    ...
    <div class="form-container sign-up">
      <form action="./api/api_login.php">
        ...
        if (isset($_SESSION['message_register'])) { ?>
          <div class="alert alert-warning alert-dismissible fade show d-flex justify-content-between" style="margin: 10px 0;">
    ...
    <div class="toggle-container">
      <div class="toggle">
        <div class="toggle-panel toggle-left">
          <h1>Register to UPTM FCMS</h1>
          <p>An easy way to book your court</p>
          <button class="hidden" id="login">Sign In</button>
        </div>
        <div class="toggle-panel toggle-right">
          <h1>Welcome to UPTM FCMS </h1>
          <p>Register with your personal details to book your court</p>
