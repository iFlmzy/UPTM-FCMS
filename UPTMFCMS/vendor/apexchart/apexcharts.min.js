...
!(function (t, e) {
          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var w,
                  k = { maxWidth: g, fontSize: (n = n || "11px"), fontFamily: l };
                return (
                  Array.isArray(r)
                    ? (w = m.globals.dom.Paper.text(function (t) {
                        for (var a = 0; a < r.length; a++) (y = r[a]), g && (y = i.getTextBasedOnMaxWidth(e({ text: r[a] }, k))), 0 === a ? t.tspan(y) : t.tspan(y).newLine();
                      }))
                    : (g && (y = this.getTextBasedOnMaxWidth(e({ text: r }, k))),
                      (w = x
                        ? m.globals.dom.Paper.plain(r)
                        : m.globals.dom.Paper.text(function (t) {
                            return t.tspan(y);
                          }))),
                  w.attr({ x: a, y: s, "text-anchor": o, "dominant-baseline": v, "font-size": n, "font-family": l, "font-weight": h, fill: c, class: "apexcharts-text " + p }),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                ...
                void 0 !== e.seriesIndex && i.globals.barWidth && !this.annoCtx.invertAxis && (o = o - (i.globals.barWidth / 2) * (i.globals.series.length - 1) + i.globals.barWidth * e.seriesIndex),
                "x1" === t ? o : n
              );
            },
          },
  ...
  var C = {
              ...
              return {
                ...
                plotOptions: {
                  ...
                  bar: {
                    ...
                    dataLabels: { position: "top", maxItems: 100, hideOverflowingLabels: !0, orientation: "horizontal", total: { enabled: !1, formatter: void 0, offsetX: 0, offsetY: 0, style: { color: "#373d3f", fontSize: "12px", fontFamily: void 0, fontWeight: 600 } } },
                  },
                  ...
                  treemap: { enableShades: !0, shadeIntensity: 0.5, distributed: !1, reverseNegativeShade: !1, useFillColorAsStroke: !1, dataLabels: { format: "scale" }, colorScale: { inverse: !1, ranges: [], min: void 0, max: void 0 } },
                  radialBar: {
                    inverseOrder: !1,
                    startAngle: 0,
                    endAngle: 360,
                ...
                stroke: {
                  ...
                  colors: void 0,
                  dashArray: 0,
                  fill: { type: "solid", colors: void 0, opacity: 0.85, gradient: { shade: "dark", type: "horizontal", shadeIntensity: 0.5, gradientToColors: void 0, inverseColors: !0, opacityFrom: 1, opacityTo: 1, stops: [0, 50, 100], colorStops: [] } },
                },
                tooltip: {
                  enabled: !0,
                  enabledOnSeries: void 0,
    ...
    M = function (t) {
      ...
      ("function" == typeof p && (g = p(g, f)), null !== (e = l.config.series[s].data[r]) && void 0 !== e && e.x && (d = l.config.series[s].data[r].x), i) ||
        ("datetime" === l.config.xaxis.type && (d = new T(a).xLabelFormat(l.globals.ttKeyFormatter, d, d, { i: void 0, dateFormatter: new I(a).formatDate, w: l })));
      ...
      return (
        r(t, [
          ...
          },
          {
            ...
            value: function () {
              var t = this.bar();
              return e(e({}, t), {}, { plotOptions: e(e({}, t.plotOptions), {}, { bar: e(e({}, t.plotOptions.bar), {}, { borderRadiusApplication: "end", borderRadiusWhenStacked: "last" }) }) });
            },
          },
          {
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t) {
              t.theme &&
                "dark" === t.theme.mode &&
                (t.tooltip || (t.tooltip = {}), "light" !== t.tooltip.theme && (t.tooltip.theme = "dark"), t.chart.foreColor || (t.chart.foreColor = "#f6f7f8"), t.chart.background || (t.chart.background = "#424242"), t.theme.palette || (t.theme.palette = "palette4"));
            },
          },
          {
              ...
              if (((o.globals.markers.size[e] > 0 || r || d) && (h = c.group({ class: r || d ? "" : "apexcharts-series-markers" })).attr("clip-path", "url(#gridRectMarkerMask".concat(o.globals.cuid, ")")), Array.isArray(l.x)))
                for (var g = 0; g < l.x.length; g++) {
                  ...
                  if ((("line" !== o.config.chart.type && "area" !== o.config.chart.type) || o.globals.comboCharts || o.config.tooltip.intersect || (p += " no-pointer-events"), (Array.isArray(o.config.markers.size) ? o.globals.markers.size[e] > 0 : o.config.markers.size > 0) || r || d)) {
                    ...
                    o.config.series[n].data[u] && (o.config.series[n].data[u].fillColor && (f.pointFillColor = o.config.series[n].data[u].fillColor), o.config.series[n].data[u].strokeColor && (f.pointStrokeColor = o.config.series[n].data[u].strokeColor)),
                      a && (f.pSize = a),
          ...
          },
          {
            ...
            value: function (t, e) {
              for (var i = this.w.config, a = this.w.globals, s = "boxPlot" === i.chart.type || "boxPlot" === i.series[e].type, r = 0; r < t[e].data.length; r++)
                if (
                  (void 0 !== t[e].data[r][1] &&
                    (Array.isArray(t[e].data[r][1]) && 4 === t[e].data[r][1].length && !s ? this.twoDSeries.push(x.parseNumber(t[e].data[r][1][3])) : t[e].data[r].length >= 5 ? this.twoDSeries.push(x.parseNumber(t[e].data[r][4])) : this.twoDSeries.push(x.parseNumber(t[e].data[r][1])),
                ...
                if (l || c)
                  if (l || i.xaxis.convertedCatToNumeric) {
                    ...
                    "datetime" !== i.xaxis.type || d
                      ? ((this.fallbackToCategory = !0), this.twoDSeriesX.push(t[r].data[n].x), isNaN(t[r].data[n].x) || "category" === this.w.config.xaxis.type || "string" == typeof t[r].data[n].x || (a.isXNumeric = !0))
            ...
            value: function (t) {
                ...
                k = function (t, e) {
                  if ((d.length && 0 === e && g.push(d.join(r)), t.data)) {
                    ...
                    for (var a = 0; a < t.data.length; a++) {
                      ...
                      ("candlestick" === l.config.chart.type || (t.type && "candlestick" === t.type)) && (d.pop(), d.push(l.globals.seriesCandleO[e][a]), d.push(l.globals.seriesCandleH[e][a]), d.push(l.globals.seriesCandleL[e][a]), d.push(l.globals.seriesCandleC[e][a])),
                        ("boxPlot" === l.config.chart.type || (t.type && "boxPlot" === t.type)) &&
                          (d.pop(), d.push(l.globals.seriesCandleO[e][a]), d.push(l.globals.seriesCandleH[e][a]), d.push(l.globals.seriesCandleM[e][a]), d.push(l.globals.seriesCandleL[e][a]), d.push(l.globals.seriesCandleC[e][a])),
                        "rangeBar" === l.config.chart.type && (d.pop(), d.push(l.globals.seriesRangeStart[e][a]), d.push(l.globals.seriesRangeEnd[e][a])),
              ...
              d.push(l.config.chart.toolbar.export.csv.headerCategory),
                "boxPlot" === l.config.chart.type
                  ? (d.push("minimum"), d.push("q1"), d.push("median"), d.push("q3"), d.push("maximum"))
                  : "candlestick" === l.config.chart.type
                  ? (d.push("open"), d.push("high"), d.push("low"), d.push("close"))
                ...
                l.globals.axisCharts || (d.push(l.config.chart.toolbar.export.csv.headerValue), g.push(d.join(r))),
            ...
            value: function (t) {
              ...
              if (s.config.grid.xaxis.lines.show || s.config.xaxis.axisTicks.show) {
                ...
                s.globals.timescaleLabels.length
                  ? (function (t) {
                      for (var a = t.xC, s = t.x1, r = t.y1, o = t.x2, n = t.y2, l = 0; l < a; l++) (s = e.xaxisLabels[l].position), (o = e.xaxisLabels[l].position), e._drawGridLines({ i: l, x1: s, y1: r, x2: o, y2: n, xCount: i, parent: e.elgridLinesV });
                  ...
                  : (s.globals.isXNumeric && (i = s.globals.xAxisScale.result.length),
                    (function (t) {
                      for (var a = t.xC, r = t.x1, o = t.y1, n = t.x2, l = t.y2, h = 0; h < a + (s.globals.isXNumeric ? 0 : 1); h++)
                        0 === h && 1 === a && 1 === s.globals.dataPoints && (n = r = s.globals.gridWidth / 2), e._drawGridLines({ i: h, x1: r, y1: o, x2: n, y2: l, xCount: i, parent: e.elgridLinesV }), (n = r += s.globals.gridWidth / (s.globals.isXNumeric ? a - 1 : a));
                    })({ xC: i, x1: o, y1: 0, x2: r, y2: n }));
              }
            ...
            value: function (t) {
              ...
              if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
                for (var a, s = i.globals.padHorizontal, r = i.globals.gridHeight, o = 0; o < e + 1; o++) {
                  i.config.grid.xaxis.lines.show && this._drawGridLine({ i: o, xCount: e + 1, x1: s, y1: 0, x2: a, y2: r, parent: this.elgridLinesV }), new V(this.ctx).drawXaxisTicks(s, 0, i.globals.dom.elGraphical), (a = s = s + i.globals.gridWidth / e + 0.3);
                }
              ...
              if (!t.globals.isBarHorizontal || this.isRangeBar) {
                ...
                if (((i = this.xaxisLabels.length), this.isRangeBar))
                  i--,
                    ...
                    (null === (r = t.globals.yAxisScale) || void 0 === r || null === (o = r[0]) || void 0 === o || null === (n = o.result) || void 0 === n ? void 0 : n.length) > 0 && "datetime" !== t.config.xaxis.type && (i = t.globals.yAxisScale[0].result.length - 1);
                  ...
                  d.forEach(function (t, i) {
                    ...
                    s.chart.stacked &&
                      ...
                      t.forEach(function (i, l) {
                        t[l].key === e &&
                          (void 0 !== s.yaxis[e].min && (o = "function" == typeof s.yaxis[e].min ? s.yaxis[e].min(r.minY) : s.yaxis[e].min), void 0 !== s.yaxis[e].max && (n = "function" == typeof s.yaxis[e].max ? s.yaxis[e].max(r.maxY) : s.yaxis[e].max), a.setYScaleForIndex(e, o, n));
                      });
                  });
                });
            },
                      ...
                      ("candlestick" !== this.w.config.chart.type && "boxPlot" !== this.w.config.chart.type && "rangeArea" === this.w.config.chart.type && "rangeBar" === this.w.config.chart.type) ||
                        (("candlestick" !== this.w.config.chart.type && "boxPlot" !== this.w.config.chart.type) ||
                          (void 0 !== r.seriesCandleC[d][g] &&
                            ((o = Math.max(o, r.seriesCandleO[d][g])), (o = Math.max(o, r.seriesCandleH[d][g])), (o = Math.max(o, r.seriesCandleL[d][g])), (o = Math.max(o, r.seriesCandleC[d][g])), "boxPlot" === this.w.config.chart.type && (o = Math.max(o, r.seriesCandleM[d][g])))),
                        !s.series[d].type || ("candlestick" === s.series[d].type && "boxPlot" === s.series[d].type && "rangeArea" === s.series[d].type && "rangeBar" === s.series[d].type) || ((o = Math.max(o, r.series[d][g])), (e = Math.min(e, r.series[d][g]))),
                        (i = o)),
                      r.seriesGoals[d] &&
                        r.seriesGoals[d][g] &&
                    ...
                    t.w.config.series
                      ...
                      .forEach(function (r) {
                        for (var o = 0; o < e.series[e.maxValsInArrayIndex].length; o++) {
                          var n, l;
                          void 0 === a[i][o] && ((a[i][o] = 0), (s[i][o] = 0)),
                            ((t.w.config.chart.stacked && !e.comboCharts) || (t.w.config.chart.stacked && e.comboCharts && (!t.w.config.chart.stackOnlyBar || "bar" === (null === (n = t.w.config.series) || void 0 === n || null === (l = n[r]) || void 0 === l ? void 0 : l.type)))) &&
                              null !== e.series[r][o] &&
                              x.isNumber(e.series[r][o]) &&
                              (e.series[r][o] > 0 ? (a[i][o] += parseFloat(e.series[r][o]) + 1e-4) : (s[i][o] += parseFloat(e.series[r][o])));
                        }
                      });
                }),
                  ...
                  : ((i.globals.colors = i.config.colors),
                    Array.isArray(i.config.colors) &&
                      ...
                      (i.globals.colors = i.config.series.map(function (t, a) {
                        ...
                        return s || (s = i.config.colors[0]), "function" == typeof s ? ((e.isColorFn = !0), s({ value: i.globals.axisCharts ? (i.globals.series[a][0] ? i.globals.series[a][0] : 0) : i.globals.series[a], seriesIndex: a, dataPointIndex: a, w: i })) : s;
                      }))),
            ...
            value: function () {
              ...
              if ((e.config.xaxis.convertedCatToNumeric && 0 === i.length && (i = e.globals.categoryLabels), e.globals.timescaleLabels.length > 0)) {
                ...
                if (
                  ...
                  ((t = { width: c.width >= d.width ? c.width : d.width, height: c.height >= d.height ? c.height : d.height }).width * i.length > e.globals.svgWidth - this.dCtx.lgWidthForSideLegends - this.dCtx.yAxisWidth - this.dCtx.gridPad.left - this.dCtx.gridPad.right &&
                    ...
                    (function (t) {
                      if (e.dCtx.timescaleLabels && e.dCtx.timescaleLabels.length) {
                        ...
                        "datetime" === r
                          ...
                          : "datetime" !== r && e.dCtx.gridPad.right < o / 2 - e.dCtx.yAxisWidthRight && !a.rotateXLabels && !i.config.xaxis.labels.trim && ("between" !== i.config.xaxis.tickPlacement || i.globals.isBarHorizontal) && (e.dCtx.xPadRight = o / 2 + 1);
                    })(t);
                };
              ...
              if (a.globals.axisCharts) {
                ...
                if (
                  (a.config.yaxis[i] &&
                    ...
                    ((r = !0), a.globals.ancillaryCollapsedSeriesIndices.indexOf(i) < 0 && (a.globals.ancillaryCollapsedSeries.push({ index: i, data: s[i].data.slice(), type: e.parentNode.className.baseVal.split("-")[1] }), a.globals.ancillaryCollapsedSeriesIndices.push(i))),
                  !r)
                ) {
            ...
            value: function () {
              ...
              for (var o = e.globals.legendFormatter, n = e.config.legend.inverseOrder, l = n ? a.length - 1 : 0; n ? l >= 0 : l <= a.length - 1; n ? l-- : l++) {
                ...
                (L.background = s[l]),
                  ...
                  void 0 !== e.globals.seriesColors[l] && ((L.background = e.globals.seriesColors[l]), (L.color = e.globals.seriesColors[l])),
                ...
                T || (T = e.config.chart.foreColor),
                  ...
                  m.setAttrs(I, { rel: l + 1, i: l, "data:default-text": encodeURIComponent(c), "data:collapsed": d || g }),
                  P.appendChild(f),
                  P.appendChild(I);
                ...
                e.config.legend.showForNullSeries || (M.isSeriesNull(l) && -1 === e.globals.collapsedSeriesIndices.indexOf(l) && -1 === e.globals.ancillaryCollapsedSeriesIndices.indexOf(l) && P.classList.add("apexcharts-hidden-null-series")),
                  ...
                  m.setAttrs(P, { rel: l + 1, seriesName: x.escapeString(a[l]), "data:collapsed": d || g }),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (
                ...
                this.elMenuItems.push(document.createElement("div")), (this.elMenuItems[i].innerHTML = e[i].title), m.setAttrs(this.elMenuItems[i], { class: "apexcharts-menu-item ".concat(e[i].name), title: e[i].title }), this.elMenu.appendChild(this.elMenuItems[i]);
            },
          },
          {
            ...
            value: function () {
              ...
              if (!t.globals.zoomEnabled)
                if (void 0 !== t.globals.selection && null !== t.globals.selection) this.drawSelectionRect(t.globals.selection);
                  ...
                  var s = { x: i, y: 0, width: a, height: t.globals.gridHeight, translateX: 0, translateY: 0, selectionEnabled: !0 };
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                (g = "x" === i ? { x: l ? o - c : o, y: 0, width: c, height: a.globals.gridHeight } : "y" === i ? { x: 0, y: h ? n - d : n, width: a.globals.gridWidth, height: d } : { x: l ? o - c : o, y: h ? n - d : n, width: c, height: d }),
                ...
                "function" == typeof a.config.chart.events.selection &&
                  ...
                  (this.w.globals.selectionResizeTimer = window.setTimeout(function () {
                    ...
                    a.globals.isRangeBar
                      ? ((t = a.globals.yAxisScale[0].niceMin + (h.left - l.left) * s.invertedYRatio), (e = a.globals.yAxisScale[0].niceMin + (h.right - l.left) * s.invertedYRatio), (o = 0), (n = 1))
                      : ((t = a.globals.xAxisScale.niceMin + (h.left - l.left) * s.xRatio),
                    ...
                    if (c.globals.axisCharts) {
                      var y = function (t) {
                        ...
                        return c.globals.isRangeData
                          ? v.yLbFormatter(null === (e = c.globals.seriesRangeStart) || void 0 === e || null === (i = e[t]) || void 0 === i ? void 0 : i[r], { series: c.globals.seriesRangeStart, seriesIndex: t, dataPointIndex: r, w: c }) +
                              " - " +
                              v.yLbFormatter(null === (a = c.globals.seriesRangeEnd) || void 0 === a || null === (s = a[t]) || void 0 === s ? void 0 : s[r], { series: c.globals.seriesRangeEnd, seriesIndex: t, dataPointIndex: r, w: c })
          ...
          },
          {
            ...
            value: function (t) {
              ...
              b && (b.innerHTML = void 0 !== c ? c : ""),
                f[0] && f[0].classList.contains("apexcharts-tooltip-marker") && (l.config.tooltip.marker.fillColors && Array.isArray(l.config.tooltip.marker.fillColors) && (n = l.config.tooltip.marker.fillColors[e]), (f[0].style.backgroundColor = n)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              a.globals.isXNumeric && "datetime" === a.config.xaxis.type
                ? (r = new T(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, d, d, { i: void 0, dateFormatter: new I(this.ctx).formatDate, w: this.w }))
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              i.globals.isXNumeric
                ...
                : i.globals.isBarHorizontal || ((n = a.xAxisTicksPositions[t - 1] + a.dataPointsDividedWidth / 2), isNaN(n) && (n = a.xAxisTicksPositions[t] - a.dataPointsDividedWidth / 2)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (g.contains("apexcharts-bar-area") || g.contains("apexcharts-candlestick-area") || g.contains("apexcharts-boxPlot-area") || g.contains("apexcharts-rangebar-area")) {
                ...
                o.tooltipLabels.drawSeriesTexts({ ttItems: a.ttItems, i: n, j: r, y1: w ? parseInt(w, 10) : null, y2: k ? parseInt(k, 10) : null, shared: !o.showOnIntersect && s.config.tooltip.shared, e: i }),
            ...
            value: function () {
              ...
              if (
                ...
                (s
                  ...
                  : a
                  ? (n = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-bar-area, .apexcharts-series .apexcharts-candlestick-area, .apexcharts-series .apexcharts-boxPlot-area, .apexcharts-series .apexcharts-rangebar-area"))
        ...
        r(t, [
          {
            ...
            value: function (t) {
              ...
              return (
                (L = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(Y) : this.calculateColumnsDataLabelsPosition(Y)),
                f.attr({ cy: L.bcy, cx: L.bcx, j: o, val: h[r][o], barHeight: c, barWidth: d }),
                (k = this.drawCalculatedDataLabels({ x: L.dataLabelsX, y: L.dataLabelsY, val: this.barCtx.isRangeBar ? [a, s] : h[r][o], i: n, j: o, barWidth: d, barHeight: c, textRects: X, dataLabelsConfig: P })),
                x.config.chart.stacked &&
                  T.enabled &&
                  (A = this.drawTotalDataLabels({ x: L.totalDataLabelsX, y: L.totalDataLabelsY, barWidth: d, barHeight: c, realIndex: n, textAnchor: L.totalDataLabelsAnchor, val: this.getStackedTotalDataLabel({ realIndex: n, j: o }), dataLabelsConfig: P, barTotalDataLabelsConfig: T })),
        ...
        r(t, [
            ...
            value: function () {
              ...
              if ((l.config.plotOptions.bar.rangeBarGroupRows && (c = 1), this.barCtx.isHorizontal))
                ...
                if (((a = l.globals.gridWidth / this.barCtx.visibleItems), l.config.xaxis.convertedCatToNumeric && (a = l.globals.gridWidth / l.globals.dataPoints), (r = ((a / c) * parseInt(this.barCtx.barOptions.columnWidth, 10)) / 100), l.globals.isXNumeric)) {
                  ...
                  l.config.xaxis.convertedCatToNumeric && (d = this.barCtx.initialXRatio), l.globals.minXDiff && 0.5 !== l.globals.minXDiff && l.globals.minXDiff / d > 0 && (a = l.globals.minXDiff / d), (r = ((a / c) * parseInt(this.barCtx.barOptions.columnWidth, 10)) / 100) < 1 && (r = 1);
                }
              ...
              return (l.globals.barHeight = s), (l.globals.barWidth = r), { x: t, y: e, yDivision: i, xDivision: a, barHeight: s, barWidth: r, zeroH: o, zeroW: n };
            },
          },
          {
            ...
            value: function (t, e, i, a) {
              ...
              return (
                ...
                h.fillPath({
                  ...
                  fillType:
                    null !== (r = l.config.series[e].data[i]) && void 0 !== r && null !== (o = r.fill) && void 0 !== o && o.type ? (null === (n = l.config.series[e].data[i]) || void 0 === n ? void 0 : n.fill.type) : Array.isArray(l.config.fill.type) ? l.config.fill.type[e] : l.config.fill.type,
                })
              );
            },
          },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var y = g.line(s, x - o);
              if (
                ((b = b + g.line(r, f) + g.line(r, x - o) + y + ("around" === d.config.plotOptions.bar.borderRadiusApplication ? " Z" : " z")),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return g.drawPath({ d: p, fill: u.shadeColor(0.5, x.rgb2hex(a)), stroke: "none", strokeWidth: 0, fillOpacity: 1, classes: "apexcharts-bar-shadows" });
            },
          },
          {
            ...
            value: function (t) {
              var e = t.i,
                ...
                r = 0;
              return (
                a.globals.seriesPercent.forEach(function (t, a) {
                  t[i] && s++, a < e && 0 === t[i] && r++;
                }),
        ...
        r(t, [
            ...
            value: function (t, i) {
              ...
              for (var n = 0, l = 0; n < t.length; n++, l++) {
                ...
                for (var I = 0; I < a.globals.dataPoints; I++) {
                  ...
                  this.isHorizontal
                    ? ((M = this.drawBarPaths(e(e({}, z), {}, { barHeight: k, zeroW: g, yDivision: c }))), (A = this.series[n][I] / this.invertedYRatio))
                    : ((M = this.drawColumnPaths(e(e({}, z), {}, { xDivision: h, barWidth: A, zeroH: d }))), (k = this.series[n][I] / this.yRatio[this.yaxisIndex]));
          ...
          },
          {
            ...
            value: function (t) {
              ...
              z.count > 0 && s >= P.globals.dataPoints - z.count && (M.node.setAttribute("stroke-dasharray", z.dashArray), M.node.setAttribute("stroke-width", z.strokeWidth), M.node.setAttribute("fill-opacity", z.fillOpacity)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                { pathTo: f.pathTo, pathFrom: f.pathFrom, x1: r, x: o, y: n, goalX: this.barHelpers.getGoalValues("x", r, null, d, g), barYPosition: e, barHeight: a }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                this.barHelpers.barBackground({ bc: p, j: u, i: g, x1: e - l / 2 - o * this.visibleI, x2: o * this.seriesLen + l / 2, elSeries: h }),
                { pathTo: m.pathTo, pathFrom: m.pathFrom, x: a, y: s, goalY: this.barHelpers.getGoalValues("y", null, n, g, u), barXPosition: e, barWidth: o }
              );
            },
          },
          {
        ...
        r(s, [
                  ...
                  h = function (r, h) {
                    ...
                    for (var C = 0; C < s.globals.dataPoints; C++) {
                      var L = a.barHelpers.getStrokeWidth(r, C, v),
                        ...
                        I = null;
                      a.isHorizontal
                        ? ((I = a.drawStackedBarPaths(e(e({}, P), {}, { zeroW: u, barHeight: k, yDivision: d }))), (A = a.series[r][C] / a.invertedYRatio))
                        : ((I = a.drawStackedColumnPaths(e(e({}, P), {}, { xDivision: c, barWidth: A, zeroH: g }))), (k = a.series[r][C] / a.yRatio[a.yaxisIndex]));
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r) {
              ...
              return (
                this.isHorizontal
                  ? ((l = ((l = a = c.globals.gridHeight / c.globals.dataPoints) * parseInt(c.config.plotOptions.bar.barHeight, 10)) / 100),
            ...
            value: function (t) {
              ...
              if ((h && (v = h.indexOf(g.config.series[p].name)), v > 0)) {
                ...
                this.groupCtx.prevXVal[v - 1][f] < 0
                  ? (m = this.series[p][f] >= 0 ? this.groupCtx.prevX[v - 1][f] + x - 2 * (this.isReversed ? x : 0) : this.groupCtx.prevX[v - 1][f])
                  : this.groupCtx.prevXVal[v - 1][f] >= 0 && (m = this.series[p][f] >= 0 ? this.groupCtx.prevX[v - 1][f] : this.groupCtx.prevX[v - 1][f] - x + 2 * (this.isReversed ? x : 0)),
                  (e = m);
              } else e = r;
                    ...
                    for (
                      var A = o.group({ class: "apexcharts-datalabels", "data:realIndex": v }),
                        S = function (a) {
                          ...
                          (c = s.isHorizontal ? s.drawHorizontalBoxPaths(e(e({}, x), {}, { yDivision: h, barHeight: y, zeroW: g })) : s.drawVerticalBoxPaths(e(e({}, x), {}, { xDivision: n, barWidth: w, zeroH: d }))),
                            (p = c.y),
                            (u = c.x),
                            a > 0 && b.push(u + w / 2),
                            f.push(p),
              ...
              for (var h = n ? 0 : l.length - 1; n ? h < l.length : h >= 0; n ? h++ : h--) {
                ...
                for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, p = 0; p < l[h].length; p++) {
                  ...
                  if (
                    ...
                    c.add(k),
                    k.attr({ fill: b, i: h, index: h, j: p, val: t[h][p], "stroke-width": this.strokeWidth, stroke: e.config.plotOptions.heatmap.useFillColorAsStroke ? b : e.globals.stroke.colors[0], color: b }),
        ...
        r(t, [
              ...
              for (var d = 0; d < t.length; d++) {
                ...
                if (
                  ...
                  this.dynamicAnim && i.globals.dataChanged
                    ? this.animatePaths(b, { size: this.sliceSizes[d], endAngle: h, startAngle: n, prevStartAngle: l, prevEndAngle: c, animateStartingPos: !0, i: d, animBeginArr: this.animBeginArr, shouldSetPrevPaths: !0, dur: i.config.chart.animations.dynamicAnimation.speed })
              ...
              l.globals.dataChanged &&
                ...
                0 !== r.dur
                  ? t
                      ...
                      .during(function (l) {
                        (d = u + (a - u) * l), r.animateStartingPos && ((d = s + (a - s) * l), (g = e - s + (i - (e - s)) * l)), (o = n.getPiePath({ me: n, startAngle: g, angle: d, size: c })), t.node.setAttribute("data:pathOrig", o), t.attr({ d: o });
                      })
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                (e = "donut" === i.chartType ? [].concat(y, ["L", f.x, f.y, "A", i.donutSize, i.donutSize, 0, v, 0, b.x, b.y, "L", d, g, "z"]).join(" ") : "pie" === i.chartType || "polarArea" === i.chartType ? [].concat(y, ["L", i.centerX, i.centerY, "L", d, g]).join(" ") : [].concat(y).join(" ")),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              var u = t.value.formatter,
                ...
                f = "";
              if (
                (r ? ((o = t.total.color), (c = t.total.fontSize), (d = t.total.fontFamily), (g = t.total.fontWeight), (f = t.total.label), (p = t.total.formatter(i))) : 1 === i.globals.series.length && ((p = u(i.globals.series[0], i)), (f = i.globals.seriesNames[0])),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var f = p ? t.series.length - 1 : 0; p ? f >= 0 : f < t.series.length; p ? f-- : f++) {
                ...
                if ((s.setSelectionFilter(I, 0, f), this.addListeners(I, this.radialDataLabels), b.add(I), I.attr({ index: 0, j: f }), this.barLabels.enabled)) {
                  ...
                  var Y = M.x - this.barLabels.margin,
                    F = M.y,
                    H = i.drawText({ x: Y, y: F, text: z, textAnchor: "end", dominantBaseline: "middle", fontFamily: this.barLabels.fontFamily, fontWeight: this.barLabels.fontWeight, fontSize: this.barLabels.fontSize, foreColor: E, cssClass: X.join(" ") });
                  H.on("click", this.onBarLabelClick), H.attr({ rel: f + 1 }), 0 !== w && H.attr({ "transform-origin": "".concat(Y, " ").concat(F), transform: "rotate(".concat(w, " 0 0)") }), b.add(H);
                }
                var D = 0;
                !this.initialAnim || e.globals.resized || e.globals.dataChanged || (D = e.config.chart.animations.speed),
                  ...
                  this.animatePaths(I, { centerX: t.centerX, centerY: t.centerY, endAngle: S, startAngle: w, prevEndAngle: C, prevStartAngle: k, size: t.size, i: f, totalItems: 2, animBeginArr: this.animBeginArr, dur: D, shouldSetPrevPaths: !0, easing: e.globals.easing });
              }
        ...
        r(s, [
            ...
            value: function (t, i) {
              ...
              for (var r = s.group({ class: "apexcharts-rangebar-series apexcharts-plot-series" }), n = 0; n < t.length; n++) {
                ...
                for (var w = s.group({ class: "apexcharts-datalabels", "data:realIndex": p }), k = s.group({ class: "apexcharts-rangebar-goals-markers" }), A = 0; A < a.globals.dataPoints; A++) {
                  ...
                  this.renderSeries(
                    (o((S = { realIndex: p, pathFill: D, lineFill: O, j: A, i: n, x: g, y: u, y1: L, y2: P, pathFrom: I.pathFrom, pathTo: I.pathTo, strokeWidth: C, elSeries: f, series: t, barHeight: b, barWidth: v, barXPosition: T, barYPosition: M }), "barWidth", v),
              ...
              return (
                this.isHorizontal
                  ? ((a = g.config.plotOptions.bar.rangeBarGroupRows ? r + h * b : r + n * this.visibleI + h * b),
                    v > -1 && !g.config.plotOptions.bar.rangeBarOverlap && (u = g.globals.seriesRange[e][v].overlaps).indexOf(p) > -1 && (a = (n = d.barHeight / u.length) * this.visibleI + (h * (100 - parseInt(this.barOptions.barHeight, 10))) / 100 / 2 + n * (this.visibleI + u.indexOf(p)) + h * b))
                  : (b > -1 && (s = g.config.plotOptions.bar.rangeBarGroupRows ? o + c * b : o + l * this.visibleI + c * b),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return { pathTo: x.pathTo, pathFrom: x.pathFrom, barHeight: f, x: i, y: p, goalY: this.barHelpers.getGoalValues("y", null, o, l, h), barXPosition: r };
            },
          },
          {
    ...
    zt = function (t) {
      for (
        var e,
          ...
          s,
          r = (function (t) {
            for (var e = [], i = t[0], a = t[1], s = (e[0] = Yt(i, a)), r = 1, o = t.length - 1; r < o; r++) (i = a), (a = t[r + 1]), (e[r] = 0.5 * (s + (s = Yt(i, a))));
            return (e[r] = s), e;
          })(t),
          o = t.length - 1,
          n = [],
    ...
    Xt = function (t, e) {
      for (var i = "", a = 0; a < t.length; a++) {
        ...
        a > 1 && Math.abs(s[o - 2] - r[n - 2]) < e / 25
          ? (i += "L".concat(s[2], ", ").concat(s[3]))
          : o > 4
          ? ((i += "C".concat(s[0], ", ").concat(s[1])), (i += ", ".concat(s[2], ", ").concat(s[3])), (i += ", ".concat(s[4], ", ").concat(s[5])))
          : o > 2 && ((i += "S".concat(s[0], ", ").concat(s[1])), (i += ", ".concat(s[2], ", ").concat(s[3])));
      }
      return i;
    },
    Et = function (t) {
          ...
          value: function (t, i, a, s) {
            ...
            for (var d = [], g = 0; g < t.length; g++) {
              ...
              var v = b,
                w = this.zeroY,
                k = this.zeroY;
              (w = this.lineHelpers.determineFirstPrevY({ i: g, series: t, prevY: w, lineYPosition: 0 }).prevY), "smooth" === o.config.stroke.curve && null === t[g][0] ? p.push(null) : p.push(w);
              "rangeArea" === l && ((k = this.lineHelpers.determineFirstPrevY({ i: g, series: s, prevY: k, lineYPosition: 0 }).prevY), f.push(k));
              var A = {
                  type: l,
                  series: t,
                  realIndex: u,
                  ...
                  x: b,
                  y: 1,
                  pathsFrom: this._calculatePathsFrom({ type: l, series: t, i: g, realIndex: u, prevX: v, prevY: w, prevY2: k }),
                  linePaths: [],
                  areaPaths: [],
                  seriesIndex: a,
                  lineYPosition: 0,
                ...
                S = this._iterateOverDataPoints(e(e({}, A), {}, { iterations: "rangeArea" === l ? t[g].length - 1 : void 0, isRangeStart: !0 }));
              if ("rangeArea" === l) {
                var C = this._calculatePathsFrom({ series: s, i: g, realIndex: u, prevX: v, prevY: k }),
                  L = this._iterateOverDataPoints(e(e({}, A), {}, { series: s, pathsFrom: C, iterations: s[g].length - 1, isRangeStart: !1 }));
                (S.linePaths[0] = L.linePath + S.linePath), (S.pathFromLine = L.pathFromLine + S.pathFromLine);
              }
              this._handlePaths({ type: l, realIndex: u, i: g, paths: S }), this.elSeries.add(this.elPointsMain), this.elSeries.add(this.elDataLabelsWrap), d.push(this.elSeries);
            }
            if (
              (void 0 !== (null === (r = o.config.series[0]) || void 0 === r ? void 0 : r.zIndex) &&
                d.sort(function (t, e) {
        ...
        },
        {
          ...
          value: function (t, e, i) {
            ...
            (this.xDivision = a.globals.gridWidth / (a.globals.dataPoints - ("on" === a.config.xaxis.tickPlacement ? 1 : 0))),
              ...
              (this.elSeries = s.group({ class: "apexcharts-series", zIndex: void 0 !== a.config.series[i].zIndex ? a.config.series[i].zIndex : i, seriesName: x.escapeString(a.globals.seriesNames[i]) })),
          ...
          value: function (t) {
            ...
            for (
              var z = function (t, e) {
                ...
                X = h,
                E = (k.config.chart.stacked && !k.globals.comboCharts) || (k.config.chart.stacked && k.globals.comboCharts && (!this.w.config.chart.stackOnlyBar || "bar" === (null === (e = this.w.config.series[o]) || void 0 === e ? void 0 : e.type))),
                Y = 0;
              Y < r;
              Y++
            ) {
              ...
              var H = this.lineHelpers.calculatePoints({ series: s, x: l, y: h, realIndex: o, i: n, j: Y, prevY: C }),
                D = this._createPaths({ type: a, series: s, i: n, realIndex: o, j: Y, x: l, y: h, y2: X, xArrj: f, yArrj: b, y2Arrj: v, linePath: L, areaPath: P, linePaths: d, areaPaths: g, seriesIndex: u, isRangeStart: y });
              (g = D.areaPaths),
                (d = D.linePaths),
                (P = D.areaPath),
                (L = D.linePath),
                !this.appendPathFrom || ("smooth" === k.config.stroke.curve && "rangeArea" === a) || ((I += A.line(l, this.zeroY)), (T += A.line(l, this.zeroY))),
                this.handleNullDataPoints(s, H, n, Y, o),
                this._handleMarkersAndLabels({ type: a, pointsPos: H, i: n, j: Y, realIndex: o, isRangeStart: y });
            }
            return { yArrj: b, xArrj: f, pathFromArea: T, areaPaths: g, pathFromLine: I, linePaths: d, linePath: L, areaPath: P };
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if ((Array.isArray(v.config.stroke.curve) && (w = Array.isArray(x) ? v.config.stroke.curve[x[a]] : v.config.stroke.curve[a]), "rangeArea" === e && (v.globals.hasNullValues || v.config.forecastDataPoints.count > 0) && "smooth" === w && (w = "straight"), "smooth" === w)) {
              ...
              null === i[a][r] && ((g += y.move(o, n)), (u += y.move(o, k))),
                "stepline" === w ? ((g = g + y.line(o, null, "H") + y.line(null, n, "V")), (u = u + y.line(o, null, "H") + y.line(null, n, "V"))) : "straight" === w && ((g += y.line(o, n)), (u += y.line(o, n))),
                r === i[a].length - 2 && ((u = u + y.line(o, k) + y.move(o, n) + "z"), "rangeArea" === e && b ? (g = g + y.line(o, c) + y.move(o, c) + "z") : (p.push(g), f.push(u)));
            }
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.firstVal,
                ...
                g = l,
                u = c(h, i, a);
              0 === e.minHour && 1 === e.minDate ? ((d = 0), (g = x.monthMod(e.minMonth)), (n = "month"), (h = e.minDate)) : 1 !== e.minDate && 0 === e.minHour && 0 === e.minMinute && ((d = 0), (l = e.minDate), (g = l), (u = c((h = l), i, a))),
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                d >= 60 && ((d = 0), 24 === (f += 1) && (f = 0)), this.timeScaleArray.push({ position: b, value: d, unit: "minute", hour: f, minute: d, day: g, year: this._getYear(p, u, 0), month: x.monthMod(u) }), (b += l), d++;
            },
          },
          {
            ...
            value: function (t) {
              for (
                var e = t.currentMillisecond, i = t.currentSecond, a = t.currentMinute, s = t.currentHour, r = t.currentDate, o = t.currentMonth, n = t.currentYear, l = t.secondsWidthOnXAxis, h = t.numberOfSeconds, c = i + 1, d = a, g = r, u = o, p = n, f = s, b = ((1e3 - e) / 1e3) * l, v = 0;
                v < h;
                v++
              )
                c >= 60 && ((c = 0), ++d >= 60 && ((d = 0), 24 === ++f && (f = 0))), this.timeScaleArray.push({ position: b, value: c, unit: "second", hour: f, minute: d, second: c, day: g, year: this._getYear(p, u, 0), month: x.monthMod(u) }), (b += l), c++;
            },
          },
          {
              ...
              s.series.map(function (e, p) {
                ...
                void 0 !== t[p].type
                  ? ("column" === t[p].type || "bar" === t[p].type
                      ? (s.series.length > 1 && a.plotOptions.bar.horizontal && console.warn("Horizontal bars are not supported in a mixed/combo chart. Please turn off `plotOptions.bar.horizontal`"), h.series.push(e), h.i.push(p), f++, (i.globals.columnSeries = h.series))
                      : "area" === t[p].type
          ...
          },
          {
            ...
            value: function () {
              ...
              e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", l),
                (t.config.chart.height && String(t.config.chart.height).indexOf("%") > 0) || ((e.dom.elWrap.style.height = l + "px"), m.setAttrs(e.dom.Paper.node, { height: l }), (e.dom.Paper.node.parentNode.parentNode.style.minHeight = l + "px"));
            },
          },
          {
                  ...
                  l.forEach(function (r, h) {
                    ...
                    if (
                      ...
                      t &&
                        ...
                        o && ((c.globals.lastXAxis = t.xaxis ? x.clone(t.xaxis) : []), (c.globals.lastYAxis = t.yaxis ? x.clone(t.yaxis) : []), (c.globals.initialConfig = x.extend({}, c.config)), (c.globals.initialSeries = x.clone(c.config.series)), t.series)))
                    ) {
            ...
            value: function (t, e) {
              ...
              return (
                i.globals.axisCharts
                  ...
                  : void 0 === e && ((a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(t, "']")).members[0]), ("pie" !== i.config.chart.type && "polarArea" !== i.config.chart.type && "donut" !== i.config.chart.type) || this.ctx.pie.pieClicked(t)),
        ...
        (a.adopt = function (e) {
          return e
            ? e.instance
              ? e.instance
              : (((i =
                  "svg" == e.nodeName ? (e.parentNode instanceof t.SVGElement ? new a.Nested() : new a.Doc()) : "linearGradient" == e.nodeName ? new a.Gradient("linear") : "radialGradient" == e.nodeName ? new a.Gradient("radial") : a[d(e.nodeName)] ? new a[d(e.nodeName)]() : new a.Element(e)).type =
                  e.nodeName),
                (i.node = e),
                (e.instance = i),
              ...
              ("string" == typeof t
                ? a.regex.isRgb.test(t)
                  ...
                  : a.regex.isHex.test(t) &&
                    ((e = a.regex.hex.exec(4 == (s = t).length ? ["#", s.substring(1, 2), s.substring(1, 2), s.substring(2, 3), s.substring(2, 3), s.substring(3, 4), s.substring(3, 4)].join("") : s)), (this.r = parseInt(e[1], 16)), (this.g = parseInt(e[2], 16)), (this.b = parseInt(e[3], 16)))
          ...
          toString: function () {
            return (function (t) {
              for (var e = 0, i = t.length, a = ""; e < i; e++)
                (a += t[e][0]),
                  null != t[e][1] &&
                    ((a += t[e][1]), null != t[e][2] && ((a += " "), (a += t[e][2]), null != t[e][3] && ((a += " "), (a += t[e][3]), (a += " "), (a += t[e][4]), null != t[e][5] && ((a += " "), (a += t[e][5]), (a += " "), (a += t[e][6]), null != t[e][7] && ((a += " "), (a += t[e][7]))))));
              return a + " ";
            })(this.value);
          },
          move: function (t, e) {
              ...
              t || (this.absPos = this.timeToAbsPos(+new Date())),
                !1 !== this.situation.loops
                  ? ((e = Math.max(this.absPos, 0)),
                    (i = Math.floor(e)),
                    !0 === this.situation.loops || i < this.situation.loops ? ((this.pos = e - i), (a = this.situation.loop), (this.situation.loop = i)) : ((this.absPos = this.situation.loops), (this.pos = 1), (a = this.situation.loop - 1), (this.situation.loop = this.situation.loops)),
          ...
          (t.prototype.snapToGrid = function (t, e, i, a) {
            ...
            return (
              void 0 !== a
                ...
                : ((i = null == i ? 3 : i), (s = [(this.parameters.box.x + t + (1 & i ? 0 : this.parameters.box.width)) % this.options.snapToGrid, (this.parameters.box.y + e + (2 & i ? 0 : this.parameters.box.height)) % this.options.snapToGrid])),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              var n = this.core.plotChartType(t, o),
                l = new O(this);
              return (
                l.bringForward(), i.config.dataLabels.background.enabled && l.dataLabelsBackground(), this.core.shiftGraphPosition(), { elGraph: n, xyRatios: o, dimensions: { plot: { left: i.globals.translateX, top: i.globals.translateY, width: i.globals.gridWidth, height: i.globals.gridHeight } } }
              );
            },
          },
          {
            ...
            value: function () {
              ...
              return new Promise(function (s, r) {
                ...
                ((i.annotations = new P(i)), i.annotations.drawImageAnnos(), i.annotations.drawTextAnnos(), "back" === a.config.grid.position) &&
                  (l && a.globals.dom.elGraphical.add(l.el), null != l && null !== (o = l.elGridBorders) && void 0 !== o && o.node && a.globals.dom.elGraphical.add(l.elGridBorders));
